...
INSERT INTO @fnmaOsar (LOANNUMBER, MD_STATEMENT_ORDER, MD_NOI_CAT_TYPE_ORDER, MD_NOI_CAT_TYPE_NAME, MD_STATEMENT_ID, MD_NOI_CAT_ORDER, STATEMENT_YEAR, NOI_CATEGORY, REPORTED, ADJUSTMENTS, NORMALIZED) 
	SELECT @ServicerLoanNumber, 0, 40, 'Cash Flow Analysis', @OpStmtName_Latest, 40, '' , 'DSCR: (NOI / Debt Service - A Note):', (SELECT REPORTED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%Deb%Serv%A%')/(SELECT REPORTED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%NOI%'), 0,  (SELECT NORMALIZED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%Deb%Serv%A%')/(SELECT NORMALIZED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%NOI%')
	UNION
	SELECT @ServicerLoanNumber, 1, 40, 'Cash Flow Analysis', @OpStmtName_Prior, 40, '' , 'DSCR: (NOI / Debt Service - A Note):', (SELECT REPORTED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 1 AND NOI_CATEGORY LIKE '%Deb%Serv%A%')/(SELECT REPORTED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 1 AND NOI_CATEGORY LIKE '%NOI%'), 0,  (SELECT NORMALIZED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 1 AND NOI_CATEGORY LIKE '%Deb%Serv%A%')/(SELECT NORMALIZED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 1 AND NOI_CATEGORY LIKE '%NOI%')
	UNION 
	SELECT @ServicerLoanNumber, 0, 40, 'Cash Flow Analysis', @OpStmtName_Latest, 50, '' , 'DSCR: (NOI / Debt Service - A, B Note):', (SELECT SUM(REPORTED) FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%Deb%Serv%')/(SELECT REPORTED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%NOI%'), 0,  (SELECT SUM(NORMALIZED) FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%Deb%Serv%')/(SELECT NORMALIZED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%NOI%')
	UNION 
	SELECT @ServicerLoanNumber, 1, 40, 'Cash Flow Analysis', @OpStmtName_Prior, 50, '' , 'DSCR: (NOI / Debt Service - A, B Note):', (SELECT SUM(REPORTED) FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 1 AND NOI_CATEGORY LIKE '%Deb%Serv%')/(SELECT REPORTED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 1 AND NOI_CATEGORY LIKE '%NOI%'), 0,  (SELECT SUM(NORMALIZED) FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 1 AND NOI_CATEGORY LIKE '%Deb%Serv%')/(SELECT NORMALIZED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 1 AND NOI_CATEGORY LIKE '%NOI%')
	UNION
	...
	UNION 
	SELECT @ServicerLoanNumber, 0, 40, 'Cash Flow Analysis', @OpStmtName_Latest, 70, '' , 'DSCR: (NCF After CapEx / Debt Service - A, B Note):', (SELECT SUM(REPORTED) FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%Deb%Serv%')/(SELECT REPORTED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%Net%Cas%Flo%'), 0,  (SELECT SUM(NORMALIZED) FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%Deb%Serv%')/(SELECT NORMALIZED FROM @fnmaOsar WHERE MD_STATEMENT_ORDER = 0 AND NOI_CATEGORY LIKE '%Net%Cas%Flo%')
	UNION 
